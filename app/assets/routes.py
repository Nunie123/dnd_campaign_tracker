...
from app import db
from app.assets.forms import SearchContent
from app.assets.forms import EmptyForm
...
def view_assets(asset_type, username):
    ...
    return render_template(
        "assets/view_assets/view_assets.html",
...
def view_campaign_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets/view_assets/view_campaign_details.html",
...
def view_setting_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets/view_assets/view_setting_details.html",
...
def view_kingdom_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets/view_assets/view_kingdom_details.html",
...
def view_city_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets/view_assets/view_city_details.html",
...
def view_point_of_interest_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets/view_assets/view_poi_details.html",
...
def view_adventure_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets/view_assets/view_adventure_details.html",
...
def view_encounter_details(id):
    ...
    form = EmptyForm()
    return render_template(
        "assets.view_encounter_details.html",
...
def get_select_dropdown_choices(asset_type):
    ...
    choices = [("", f"Select a {asset_type} later.")]
    choices.extend(
...
def create_asset(asset_type):
    ...
    if form.validate_on_submit():
        ...
        if hasattr(form, "gm_notes"):
            new_asset.gm_notes = form.gm_notes.data
...
def edit_campaign(id):
    ...
    if form.validate_on_submit():
        ...
        asset.gm_notes = form.gm_notes.data
        if form.setting.data:
            asset.setting_id = form.setting.data
        asset.updated_at = datetime.now(timezone.utc)
        db.session.commit()
        flash(_(f"Your Campaign has been updated."))
        return redirect(url_for("assets.view_campaign_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.gm_notes.data = asset.gm_notes
...
def edit_setting(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("assets.view_setting_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.short_description.data = asset.short_description
...
def edit_kingdom(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("assets.view_kingdom_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.short_description.data = asset.short_description
        form.long_description.data = asset.long_description
...
def edit_city(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("assets.view_city_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.short_description.data = asset.short_description
        form.long_description.data = asset.long_description
...
def edit_point_of_interest(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("assets.view_point_of_interest_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.short_description.data = asset.short_description
        form.long_description.data = asset.long_description
...
def edit_adventure(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("assets.view_adventure_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.short_description.data = asset.short_description
        form.long_description.data = asset.long_description
...
def edit_encounter(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("assets.view_encounter_details", id=asset.id))
    elif request.method == "GET":
        form.name.data = asset.name
        form.short_description.data = asset.short_description
        form.long_description.data = asset.long_description
