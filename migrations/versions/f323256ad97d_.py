...
Revision ID: f323256ad97d
Revises: 
Create Date: 2024-11-17 14:26:58.139532
...
def upgrade():
    ...
    with op.batch_alter_table('quest', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_quest_owner_id'), ['owner_id'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('quest', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_quest_owner_id'))
